...
//         this.moveFlagCheckRec = new egret.Rectangle(0, 0, Utils.StageUtils.getWidth() * 0.5, Utils.StageUtils.getHeight());
...
//         Utils.StageUtils.getStage().addEventListener(egret.TouchEvent.TOUCH_END, this.leaveStateEvent, this);
//         Utils.StageUtils.getStage().addEventListener(egret.TouchEvent.TOUCH_MOVE, this.heroMoveEvent, this);
//         //键盘控制
//         Utils.KeyboardUtils.addKeyDown(this.onKeyDown, this);
//         Utils.KeyboardUtils.addKeyUp(this.onKeyUp, this);
//     }
//     /**
//      * 键盘按下处理
//      * @param keyCode
...
//         } else {
//             var radian:number = Utils.MathUtils.getRadian2(this.moveFlagX, this.moveFlagY, this.mouseX, this.mouseY);
...
//             Utils.TimerManager.doFrame(1, 0, this.delKeys, this);
//         }
//     }
//     /**
//      * 停止检测
...
//         this.keys[1] = 0;
//         if (this.checkKeying) {
//             Utils.TimerManager.remove(this.delKeys, this);
