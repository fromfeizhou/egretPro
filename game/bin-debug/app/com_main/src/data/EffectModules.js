...
var EffectBase = /** @class */ (function () {
    ...
    EffectBase.prototype.init = function () {
    };
    EffectBase.prototype.clear = function () {
        var animations = this.m_pAnimations;
        for (var key in animations) {
            if (animations.hasOwnProperty(key)) {
                var sa = animations[key];
                sa.removeAction();
            }
        }
        this.m_pAnimations = [];
    };
    EffectBase.prototype.addEffect = function (type, bitmap) {
        var animations = this.getEffect(type);
        if (animations) {
            animations.addBitmap(bitmap);
        }
    };
    EffectBase.prototype.removeEffect = function (type, bitmap) {
        var animations = this.getEffect(type);
        if (animations) {
            animations.removeBitmap(bitmap);
        }
    };
    EffectBase.prototype.getEffect = function (type) {
        var animations = this.m_pAnimations[type];
        return animations;
    };
    EffectBase.prototype.loadEffect = function (type, func, target) {
        var animations = this.m_pAnimations;
        var animation = ImageEffect.load_2(type, func, target);
...
// }
/**主场景 */
var EffectMainMap = /** @class */ (function (_super_1) {
    __extends(EffectMainMap, _super_1);
    function EffectMainMap() {
        return _super_1 !== null && _super_1.apply(this, arguments) || this;
    }
    EffectMainMap.create = function () {
        return new EffectMainMap();
    };
    EffectMainMap.prototype.init = function () {
        var animations = this.m_pAnimations;
        ...
        var EMap_Solider_Left = ImageEffect.load_2(IETypes.EMap_Solider_Left);
        var EMap_Solider_Right = ImageEffect.load_2(IETypes.EMap_Solider_Right);
        var EMap_Farmer_Right_down = ImageEffect.load_2(IETypes.EMap_Farmer_Right_down);
        var EMap_Farmer_Left_Up = ImageEffect.load_2(IETypes.EMap_Farmer_Left_Up);
        var EBuild_Repair = ImageEffect.load_2(IETypes.EBuild_Repair);
...
// }
/**大地图 */
var EffectWorldMap = /** @class */ (function (_super_1) {
    __extends(EffectWorldMap, _super_1);
    function EffectWorldMap() {
        return _super_1 !== null && _super_1.apply(this, arguments) || this;
    }
    EffectWorldMap.create = function () {
        return new EffectWorldMap();
    };
    EffectWorldMap.prototype.init = function () {
        var animations = this.m_pAnimations;
        // let EBuild_Raid = ImageEffect.load_2(IETypes.EBuild_Raid);
        // let EBuild_Attack = ImageEffect.load_2(IETypes.EBuild_Attack);
        // let EBuild_Defend = ImageEffect.load_2(IETypes.EBuild_Defend);
