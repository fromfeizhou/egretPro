module com_main {
	export class HeadQuartersRewardBox extends CComponent {

		public static NAME = 'HeadQuartersRewardBox';
		...
		/** 宝箱配置信息 */
		private _config: StarRewardConfig;
		...
		/** 设置宝箱配置 */
		public SetBoxConfig(config: StarRewardConfig) {
			this._config = config;
