module com_main {
     ...
     * 新7天活动
     */
    export class SevenIIWnd extends CView {
        public static NAME = "SevenIIWnd";
        ...
        protected childrenCreated(): void {
            ...
            this.m_vo = ActivityModel.getActivityVo<AcLoginDayVo>(AcViewType.SIGN_CONTIN_DAY_2);

            this.panel0 = new SevenIILoginPanel(AcViewType.SIGN_CONTIN_DAY_2);
            this.panel1 = new SevenIIChargePanel();
            this.panel2 = new SevenIIChargePanel();
            this.panel3 = new SevenIIShopPanel(AcViewType.AC_SHOP);
            this.panel4 = new SevenIICornucopiaPanel(AcViewType.TREASEURE_BOWL);
