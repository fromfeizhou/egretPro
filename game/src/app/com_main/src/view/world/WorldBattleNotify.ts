module com_main {
     ...
     */
    export class WorldBattleNotify extends CComponent {

        private m_pIcoAttack: egret.Bitmap;
        private m_pLbNum: eui.Label;
        private m_pIconLab: egret.Bitmap;
        public constructor() {
            super();
            this.__create_res_effect();
        }
        ...
        private __create_res_effect() {
            ...
            RES.getResAsync("lb_zc_png", (k, v) => {
                if(!this.m_pIconLab) return;
                
                this.m_pIconLab.texture = k;
                this.m_pIconLab.x = 60;
                this.m_pIconLab.y =70;
                this.m_pIconLab.anchorOffsetX = this.m_pIconLab.width / 2;
                this.m_pIconLab.anchorOffsetY = this.m_pIconLab.height / 2;
                this.m_pIconLab.touchEnabled = true;
            }, this);
