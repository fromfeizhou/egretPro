module com_main {
    export class RampartSuccessResultView extends ResultView {
        ...
        public static NAME = "RampartSuccessResultView";
        public constructor(args) {
            super();

            this.name = RampartSuccessResultView.NAME;
            ...
            this.gkId = args.gkId;
            this.m_battleType = CheckPointType.CHECKPOINT;
        }
